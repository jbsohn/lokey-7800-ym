...
//
// AymEmulator.cs is a literal C# port of aym-emulator.js from aym-js,
// Copyright (c) 2001-2026 Olivier Poncet (https://github.com/ponceto/aym-js).
// As a derivative work, this file -- and the project subtree it lives in --
// is distributed under the GNU General Public License v2.0. See the
